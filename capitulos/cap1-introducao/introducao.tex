...
Por aconselhamento dos professores membros dos projeto foi escolhido a aplicação da \textit{Azure DevOps}. (Ver Figuras \ref{fig:devops-homepage} e \ref{fig:devops-boards})
