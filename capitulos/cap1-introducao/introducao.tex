...
O presente capítulo tem como objetivo fornecer uma visão geral que enquadra e estrutura os pontos explorados em maior detalhe nas secções seguintes.  

Este capítulo tem como objetivo apresentar o enquadramento e a relevância do projeto desenvolvido no âmbito da unidade curricular de Projeto Estágio (PESTI). O trabalho integrou-se no programa internacional Blended4Future, iniciativa que reúne estudantes de diferentes países europeus com o propósito de desenvolver competências técnicas e colaborativas através da realização de projetos reais para empresas parceiras.  

Ao longo deste capítulo, será descrito o contexto em que o projeto foi concebido, identificando-se o problema principal e os objetivos definidos para a sua resolução. Apresenta-se ainda a organização e a constituição da equipa de trabalho, bem como a metodologia seguida para orientar o desenvolvimento.  

Por fim, são introduzidas as tecnologias selecionadas para a implementação da solução e faz-se referência aos principais desafios encontrados durante o processo. 
